...
% TODO : Replace this graph with a table

\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.32]{memory-bar}
	\caption[Peak Memory Utilization]{Peak Memory Utilized during training with different model sizes remain similar within the same implementation}
\end{figure}
