...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\draw[rounded corners=1ex, line width=2.1pt, yellow] (-6, 0.7) rectangle (-5.1, 1.9);
	\end{tikzpicture}
...
Application development for embedded linux in general has associated with it several tools and practises, some of which are outlined in the following subsections.
