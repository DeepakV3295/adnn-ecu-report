...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-accuracy-libtorch.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-accuracy-eigen.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-accuracy-numpy.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-accuracy-cmath.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-exectime-libtorch.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-exectime-eigen.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-exectime-numpy.pgf}}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
	\centering
	\scalebox{0.64}{\input{../Body/images/comparison-exectime-cmath.pgf}}
  \end{figure}
